...
//     //       <div className="flex-shrink-0">
//     //         <Link to="/">
//     //           <img className="w-[60px] md:w-[80px] cursor-pointer" src="/Logo.png" alt="Logo" />
//     //         </Link>
//     //       </div>

//     //       <ul className="hidden md:flex flex-1 justify-center gap-6 text-white">
//     //         <li>
//     //           <Link to="/home" className="hover:text-[#FBEC13]">Home</Link>
//     //         </li>
//     //         <li>
//     //           <Link to="/about" className="hover:text-[#FBEC13]">About</Link>
//     //         </li>
//     //         <li>
//     //           <Link to="/contact" className="hover:text-[#FBEC13]">Contact</Link>
//     //         </li>
//     //       </ul>
...
//     //         <li>
//     //           <Link to="/home" className="hover:text-[#FBEC13]" onClick={() => setIsOpen(false)}>
//     //             Home
//     //           </Link>
//     //         </li>
//     //         <li>
//     //           <Link to="/about" className="hover:text-[#FBEC13]" onClick={() => setIsOpen(false)}>
//     //             About
//     //           </Link>
//     //         </li>
//     //         <li>
//     //           <Link to="/contact" className="hover:text-[#FBEC13]" onClick={() => setIsOpen(false)}>
//     //             Contact
//     //           </Link>
//     //         </li>
//     //         <li>
//     //           <Link to="/give" className="hover:text-[#FBEC13]" onClick={() => setIsOpen(false)}>
//     //             Give
//     //           </Link>
//     //         </li>
//     //         <li>
//     //           <Link to="/receive" className="hover:text-[#FBEC13]" onClick={() => setIsOpen(false)}>
//     //             Receive Jesus
//     //           </Link>
//     //         </li>
//     //       </ul>
