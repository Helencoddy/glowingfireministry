  ...
  return (
    <div className=" bg-[#121212] text-white ">
      <div className=" flex items-center justify-center py-20 mx-3 md:mx-8">
        <div className="w-full rounded-2xl p-8 grid md:grid-cols-2 gap-6 text-white">
          {/* Contact Form */}
          <div className="space-y-6">
            ...
            <form className="space-y-4 text-white">
              <input
                ...
                className="w-full p-3 border disabled:opacity-45   rounded-lg"
                required
              />
              <input
                name="email"
                ...
                className="w-full p-3 disabled:opacity-45 border rounded-lg"
                required
              />
              <input
                name="subject"
              ...
              <button
                type="submit"
                className="w-full cursor-pointer bg-[#007bff] text-white p-3 rounded-lg hover:bg-blue-600"
              ></button>
            </form>
          </div>
